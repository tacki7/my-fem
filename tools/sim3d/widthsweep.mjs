...
//   node tools/sim3d/widthsweep.mjs <mill> <stripModel> <W0 mm> <W1 mm> <step mm>
//   e.g. node tools/sim3d/widthsweep.mjs 4hi fem 990 1040 2.5   (a 4Hi slice comes on at 1028.75 mm)
...
const [mill = '4hi', model = 'fem', W0 = '990', W1 = '1040', dW = '2.5'] = process.argv.slice(2);
const rows = [];
for (let Wmm = +W0; Wmm <= +W1 + 1e-9; Wmm += +dW) {
  const p = { ...defaultParams(mill), stripModel: model, width: Wmm / 1e3 };
